...
SUITE_DIR="/home/p4bs/splint_analysis/juliet-analysis/juliet-test-suite-c/testcases/CWE685_Function_Call_With_Incorrect_Number_of_Arguments"
SUPPORT_DIR="/home/p4bs/splint_analysis/juliet-analysis/juliet-test-suite-c/testcasesupport"
TIMESTAMP=$(date +%Y%m%d%H%M%S)
LOG_BASE="/home/p4bs/splint_analysis/juliet-test-suite-c/debug/logs/CWE685_Function_Call_With_Incorrect_Number_of_Arguments/${TIMESTAMP}"
OUTPUT_CSV_DIR="/home/p4bs/splint_analysis/juliet-analysis/juliet-test-suite-c/output-csv/CWE685_Function_Call_With_Incorrect_Number_of_Arguments"
...
find "$SUITE_DIR" -name "*.c" ! -path "*w32*" | while read file; do
    ...
    bad_keyw=$(echo "$bad_output_raw" | grep -m1 -E -i "types are incompatible|Function .*? called with .*? args, expects .*" || echo "")
    ...
    good_keyw=$(echo "$good_output_raw" | grep -m1 -E -i "types are incompatible|Function .*? called with .*? args, expects .*" || echo "")
